...
if (isset($_POST['prodsave'])){
	...
	$db="biddingsystemdb";
	$conn=mysqli_connect($hostname,$user_name,$password,$db);
	mysqli_query($conn,"INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,regularprice,dateposted,duedate,status) 
						VALUES ('$prodname','$category','$descrpt','$startingbid','$name','$regularprice',NOW(),'$duedate',0)") or die(mysqli_error());
