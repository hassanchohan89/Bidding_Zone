...
<script type='text/javascript'>
	...
	mysqli_query($conn,"INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,dateposted,duedate,status,sellername,sellerpayaccount) 
 ...
 <script type='text/javascript'>
		...
		jQuery('.two').click( function() {
          ...
          <div class="details_big_box">
            ...
            <div class="specifications">
			 ...
			 <div id="regstep1" class="regstep1">
				<?php
				$hostname="localhost";
				$user_name="root";
				$password="";
				...
				mysqli_query($conn,"UPDATE member SET lastname='$last_save', firstname='$fname_save', gender='$gender_save', address='$address_save', birthdate='$bday_save' WHERE memberid='$userid'") or die (mysqli_error());
	...
	$db="biddingsystemdb";
	$conn=mysqli_connect($hostname,$user_name,$password,$db);	
			mysqli_query($conn,"UPDATE member SET password='$password_save', memberimg='$name' WHERE memberid='$userid'") or die(mysqli_error());
				...
				<div class="specifications">
					...
					<div class='hidenotif'>
						<div class="thumbs">
							...
							$db="biddingsystemdb";
							$conn=mysqli_connect($hostname,$user_name,$password,$db);
								$get = mysqli_query($conn,"SELECT * FROM needtopay WHERE needtopay.memberid = '$userid' AND needtopay.status=0")or die(mysqli_error());
								while($getit = mysqli_fetch_array($get)){
								$prod = $getit['productid'];
								$getprod = mysqli_query($conn,"SELECT * FROM products WHERE productid = '$prod'")or die(mysqli_error());
