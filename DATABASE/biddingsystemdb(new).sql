...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 12:19 AM
...
('::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, l', '2023-06-05 00:15:40'),
('::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, l', '2023-06-05 00:51:06');
...
(47, 28, '25', '2023-06-04 23:20:04', 20000, 0);
...
(25, 'Hassan', 'Azam', 'Male', 'hassanchohan89', 'test1234', 'hassanchohan89@gmail.com', 2147483647, '7 December 2001', 'Bacolod Street No.4 House No.9 Survey No.88', 'yes', 'default.jpg');
...
(16, 'ZTC Cellphone (L101+)', 10, 'Dual Sim dual standby, handwritten & keyboard \r\nListen to the music by Innervation swing screen \r\nSupports Bluetooth and wireless stereo music output \r\nSupports: FM output, MP3, MP4, GPRS, WAP \r\nSupports T-Flash card extended, USB2.0 full speed ', 2000, 'p4,gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(17, 'AT&T Samsung a877', 10, 'equipped with a QWERTY keyboard and WQVGA AMOLED Touch screen,but In fact this phone is not a smartphone,the best of this phone is features include a 3.2-inch WQVGA AMOLED touchscreen,a 3 megapixel camera, GPS, HSDPA and Bluetooth', 5000, 'p2.gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(18, 'CYLINDER AUDIO SPEAKERS', 11, '* 2.0 channel* Volume & power dial* Stereo jack to connect to computer or any audio deviceImprint Area:1-1/2\"W x 3/4\"H on speaker without dialWeight: Weight 17 lbs.', 500, 'p2.gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(19, 'Sungjut TangoX Nano UMPC', 9, 'has a DVI output and a detachable, integrated Skype phone. Weight: under 1kg. Unbelievable.', 22000, 'p2.gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(20, 'Dialogueâ€™s Flybook V33', 9, 'Dialogue is going to release the Flybook V33i series with a laptop screen which can be moved across its axis. A nice alternative to a static laptop screen weâ€™ve seen over the last years.', 23000, 'p4.gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(21, 'Indian Rings', 13, 'Basi Buy1 Take1 kay duwa ka bilog hu. .', 20000, 'p2.gif', 0, '2023-06-04', '2023-12-31', '0', '', ''),
(22, 'wew', 9, 'affdfdfdfd', 1200, 'EdwardScissorhands-tf.org-free-2008.jpg', 0, '2023-06-04', '2023-12-31', '0', 'mr.scarecrow011', 'naruto16_fanatic@yahoo.com'),
(23, 'asdfasdf', 10, 'wewe', 400, 'blazers.jpg', 0, '2023-06-04', '2023-12-31', '0', 'mr.scarecrow011', 'naruto16_fanatic@yahoo.com'),
(24, 'wewewe', 10, 'afasdfasdfasdf', 1, 'EdwardScissorhands-tf.org-free-2008.jpg', 0, '2023-06-04', '2023-12-31', '0', 'mr.scarecrow011', 'naruto16_fanatic@yahoo.com'),
(25, 'wewness to the max', 9, 'nami ni sa nami ', 12000, 'people.png', 1000, '2023-06-04', '2023-12-31', '0', '', ''),
(26, 'asdjfkasdjf', 11, 'dfaglksdlf', 90000, 'people.png', 1000, '2023-06-04', '2023-12-31', '0', '', ''),
(27, 'lsadfksa', 9, 'lskdflsdf', 10000, 'share.png', 100, '2023-06-04', '2023-12-31', '0', '', ''),
(28, 'GoPro Hero 7', 14, 'Demo description', 18500, 'CC_H7Black_2X_D.png', 26000, '2023-06-04', '2023-06-05', '1', '', ''),
(29, 'iPhone 8', 10, 'SELLER NOTE: Fully tested and restored to factory settings by our in-house technicians. \r\n4K Video Recording, Accelerometer, Camera, Colour Screen, Email, Fingerprint Sensor, FM Radio, Front Camera, Internet Browsing, MMS (Multimedia Messaging), MP3 Player, Proximity Sensor, Rear Camera, Touch Scree', 48000, 'iphn8.png', 65000, '2023-06-04', '2023-12-31', '0', '', ''),
(30, 'Dell XPS 15', 9, 'Demo Description', 95000, 'dellXPS.jpg', 150000, '2023-06-04', '2023-12-31', '0', '', '');
...
--
ALTER TABLE `bidreport`
  MODIFY `bidid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
