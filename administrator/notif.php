	...
	<div id="container">
		<div id="bgwrap">
			...
			<center><h1><br />Welcome Administrator</h1></center>
				...
				$bidnum = "SELECT * FROM bidreport LEFT JOIN member ON member.memberid = bidreport.bidder LEFT JOIN products ON products.productid = bidreport.productid WHERE bidreport.status = 0") or die(mysqli_error());
						$count = 0;
